        ...
        for dataset in datasets:
            for setting in settings:
                for n_layer in n_layers:
                    ...
                    train_path = f'{dataset}/setting_{setting_kgs[setting]}/userpykeen_setting_{setting_kgs[setting]}_train_train.tsv'
                    test_path = f'{dataset}/setting_{setting_kgs[setting]}/userpykeen_setting_{setting_kgs[setting]}_test.tsv'

                    checkpoint_name_file = f'{dataset}_checkpoints_setting_{setting_kgs[setting]}_{emb_model}_k={str(emb_dim)}_l={str(n_layer)}'
