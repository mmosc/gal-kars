...
if __name__ == "__main__":
    ...
    train_ratings = pd.read_table(os.path.join(RAW_DATA_DIR, 'ml1m', 'train.tsv'),
                                  names = ['user', 'item', 'score'], sep='\t')
    print(f'New train len {len(train_ratings)}')

    test_ratings = pd.read_table(os.path.join(RAW_DATA_DIR, 'ml1m', 'test.tsv'),
                                  names = ['user', 'item', 'score'], sep='\t')
    ...
    emb_folders = ['data/embeddings/ml1m/']
    ...
    source_features = dict(sorted((pkl.load(open('data/embeddings/ml1m/ml1m_s=1_CompGCN_k=64_l=1.pkl', 'rb'))).items()))
    ...
    feature_list = [ 
    #                 ['ml1m_s=1_CompGCN_k=64_l=1'], ['ml1m_s=1_CompGCN_k=64_l=2'], ['ml1m_s=1_CompGCN_k=64_l=3'], 
    #                 ['ml1m_s=2_CompGCN_k=64_l=1'], ['ml1m_s=2_CompGCN_k=64_l=2'], ['ml1m_s=2_CompGCN_k=64_l=3'],
    #                 ['ml1m_s=3_CompGCN_k=64_l=1'], ['ml1m_s=3_CompGCN_k=64_l=2'], ['ml1m_s=3_CompGCN_k=64_l=3'], 
    #                 ['ml1m_s=4_CompGCN_k=64_l=1'], ['ml1m_s=4_CompGCN_k=64_l=2'], ['ml1m_s=4_CompGCN_k=64_l=3'], 
    #                 ['ml1m_s=5_CompGCN_k=64_l=1'], ['ml1m_s=5_CompGCN_k=64_l=2'], ['ml1m_s=5_CompGCN_k=64_l=3'], 
    #                 ['ml1m_s=6_CompGCN_k=64_l=1'], ['ml1m_s=6_CompGCN_k=64_l=2'], ['ml1m_s=6_CompGCN_k=64_l=3'], 
    #                 ['ml1m_s=7_CompGCN_k=64_l=1'], ['ml1m_s=7_CompGCN_k=64_l=2'], ['ml1m_s=7_CompGCN_k=64_l=3'], 
                    ['ml1m_s=8_CompGCN_k=64_l=1'], ['ml1m_s=8_CompGCN_k=64_l=2'], ['ml1m_s=8_CompGCN_k=64_l=3'], 
        ]
    ...
    for i, config in enumerate(feature_list):
            ...
            preds_folder = f'reports/ml1m/predictions/{setting_sources[len(x) - 1]}/'
            model_folder = f'reports/ml1m/models/{setting_sources[len(x) - 1]}/'
